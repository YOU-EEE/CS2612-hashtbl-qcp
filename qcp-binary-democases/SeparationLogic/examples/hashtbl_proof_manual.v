...
Proof.
  ...
  - match goal with
    ...
    sep_apply (store_map_split store_uint retval_2 v_old m2 Hm2_at_new).
    sep_apply store_uint_field.
    sep_apply (dup_store_uint retval_2 v_old val_pre).
    entailer!.
  - set (m2' := PV.insert_map m2 retval_2 val_pre).
    sep_apply store_uint_field.
    sep_apply (store_map_equiv_store_map_missing store_uint m2 retval_2 Hm2_at_new).
    ...
    { intros a Ha.
      ...
      reflexivity. }
    pose proof (store_map_missing_i_equiv store_uint m2 m2' retval_2 Houtside) as Heq.
    destruct Heq as [Hmiss _].
    sep_apply Hmiss.
    assert (Hm2'_at_new : m2' retval_2 = Some val_pre).
    { unfold m2'. apply PV.insert_map_same. }
    sep_apply (store_map_merge store_uint retval_2 val_pre m2' Hm2'_at_new).
