...
PL_FILE_NAMES = \
	FixedPoint.v Monad.v  Kleene.v Syntax.v SimpleProofsAndDefs.v HighOrder.v SimpleInductiveType.v AlgebraicStructure.v Rewrite.v DenotationsOfExpr.v DenotationsAsRels.v Sets.v logic.v MoreInductiveType.v Sets2.v BuiltInNat.v 
PL_FILES=$(PL_FILE_NAMES:%.v=$(PL_DIR)/%.v)

ASSIGNMENT_FILE_NAMES = \
	Assignment1011.v Assignment1015b.v
